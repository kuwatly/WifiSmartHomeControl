...
/*--------------------------------------------*/
#define MY_DEFAULT_SSID_NAME                "MCHP_xxxx"
...
#define MY_DEFAULT_LIST_RETRY_COUNT_INFRASTRUCTURE  (WF_RETRY_FOREVER)  /* Number of times to try to connect to the SSID when using Infrastructure network type */
	...
	#define MY_DEFAULT_LIST_RETRY_COUNT MY_DEFAULT_LIST_RETRY_COUNT_ADHOC
#else
	#define MY_DEFAULT_LIST_RETRY_COUNT MY_DEFAULT_LIST_RETRY_COUNT_INFRASTRUCTURE
#endif
...
#define MY_DEFAULT_WEP_KEY_INDEX        (0)
	...
	#define MY_DEFAULT_WIFI_SECURITY_KEY	{MY_DEFAULT_WEB_KEYS_40}
	#define MY_DEFAULT_WIFI_SECURITY_KEY_LEN (sizeof(MY_DEFAULT_WEP_KEYS_40) - 1)
#elif MY_DEFAULT_WIFI_SECURITY_MODE == WF_SECURITY_WEP_104
	#define MY_DEFAULT_WIFI_SECURITY_KEY	{MY_DEFAULT_WEP_KEYS_104}
	#define MY_DEFAULT_WIFI_SECURITY_KEY_LEN	(sizeof(MY_DEFAULT_WEP_KEYS_104) - 1)
#elif (MY_DEFAULT_WIFI_SECURITY_MODE == WF_SECURITY_WPA_WITH_KEY)       || \
	    (MY_DEFAULT_WIFI_SECURITY_MODE == WF_SECURITY_WPA2_WITH_KEY)      || \
	    (MY_DEFAULT_WIFI_SECURITY_MODE == WF_SECURITY_WPA_AUTO_WITH_KEY)
	#define MY_DEFAULT_WIFI_SECURITY_KEY	{MY_DEFAULT_PSK}
	#define MY_DEFAULT_WIFI_SECURITY_KEY_LEN	(sizeof(MY_DEFAULT_PSK) - 1)
#elif (MY_DEFAULT_WIFI_SECURITY_MODE == WF_SECURITY_WPA_WITH_PASS_PHRASE)     || \
	    (MY_DEFAULT_WIFI_SECURITY_MODE == WF_SECURITY_WPA2_WITH_PASS_PHRASE)    || \
	    (MY_DEFAULT_WIFI_SECURITY_MODE == WF_SECURITY_WPA_AUTO_WITH_PASS_PHRASE)
	#define MY_DEFAULT_WIFI_SECURITY_KEY	{MY_DEFAULT_PSK_PHRASE}
	#define MY_DEFAULT_WIFI_SECURITY_KEY_LEN	(sizeof(MY_DEFAULT_PSK_PHRASE) - 1)
#else
	  #error "No security defined"
#endif /* MY_DEFAULT_WIFI_SECURITY_MODE */


// Application WiFi Connection Routine
